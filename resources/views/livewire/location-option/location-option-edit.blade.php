<form wire:submit.prevent="submit">
    ...
    <div class="form-check form-switch mt-3">
        <input class="form-check-input" type="checkbox" id="activeSwitchEdit{{ $id }}" wire:model="is_active">
        <label class="form-check-label" for="activeSwitchEdit{{ $id }}">Active</label>
    </div>
    <div class="mt-3">
