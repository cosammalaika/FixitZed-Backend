            ...
            <div class="col-xl-10 col-lg-11">
                ...
                <div class="card shadow-sm mb-4 settings-card">
                    ...
                    <div class="card-body row g-4 align-items-start">
                        <div class="col-md-4">
                            <form wire:submit.prevent="saveField('currency_code')" class="d-grid gap-2">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary btn-sm" wire:loading.attr="disabled">Save</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-4">
                            <form wire:submit.prevent="saveField('currency_symbol')" class="d-grid gap-2">
                        ...
                        <div class="col-md-4">
                            <form wire:submit.prevent="saveField('currency_name')" class="d-grid gap-2">
                ...
                <div class="card shadow-sm mb-4 settings-card">
                    ...
                    <div class="card-body row g-4">
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('loyalty_point_value')" class="d-grid gap-2">
                        ...
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('loyalty_redeem_threshold_value')" class="d-grid gap-2">
                ...
                <div class="card shadow-sm mb-4 settings-card">
                    ...
                    <div class="card-body row g-4">
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('notifications_retention_days')" class="d-grid gap-2">
                        ...
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('notifications_per_page')" class="d-grid gap-2">
                ...
                <div class="card shadow-sm mb-4 settings-card">
                    ...
                    <div class="card-body row g-4">
                        <div class="col-md-3">
                            <form wire:submit.prevent="saveField('matching_default_radius_km')" class="d-grid gap-2">
                        ...
                        <div class="col-md-3">
                            <form wire:submit.prevent="saveField('matching_max_radius_km')" class="d-grid gap-2">
                        ...
                        <div class="col-md-3">
                            <form wire:submit.prevent="saveField('matching_radius_step_km')" class="d-grid gap-2">
                        ...
                        <div class="col-md-3">
                            <form wire:submit.prevent="saveField('matching_max_retries')" class="d-grid gap-2">
                ...
                <div class="card shadow-sm mb-4 settings-card">
                    ...
                    <div class="card-body row g-4">
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('pagination_admin_default')" class="d-grid gap-2">
                        ...
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('pagination_api_default')" class="d-grid gap-2">
                ...
                <div class="card shadow-sm mb-5 settings-card">
                    ...
                    <div class="card-body row g-4">
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('auth_password_reset_expiry')" class="d-grid gap-2">
                        ...
                        <div class="col-md-6">
                            <form wire:submit.prevent="saveField('auth_mfa_expiry')" class="d-grid gap-2">
