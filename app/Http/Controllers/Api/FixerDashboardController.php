...
class FixerDashboardController extends Controller
{
    ...
    protected function transformRequest(ServiceRequest $serviceRequest): array
    {
        ...
        return [
            ...
            'cancellation_reason_key' => $serviceRequest->cancellation_reason_key,
            'cancellation_reason_label' => $serviceRequest->cancellation_reason_label,
            'cancellation_note' => $serviceRequest->cancellation_note,
            'canceled_by' => $serviceRequest->canceled_by,
            'canceled_at' => optional($serviceRequest->canceled_at)->toIso8601String(),
